...
namespace Gamerize.DAL.Migrations
{
    ...
    [Migration("20240914203940_removeCollectionUpdateOrder")]
    partial class removeCollectionUpdateOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gamerize.DAL.Entities.Admin.Order", b =>
                {
                    b.HasOne("Gamerize.DAL.Entities.Admin.DeliveryMethod", null)
                        .WithMany("Orders")
                        .HasForeignKey("DeliveryMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gamerize.DAL.Entities.Admin.OrderStatus", null)
                        .WithMany("Orders")
                        .HasForeignKey("OrderStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gamerize.DAL.Entities.Admin.PaymentMethod", null)
                        .WithMany("Orders")
