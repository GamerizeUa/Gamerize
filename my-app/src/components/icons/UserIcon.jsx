const UserIcon = () => {
  return (
    ...
    >
      <path
        d="M16 20C11.7733 20 8.01442 22.0408 5.62135 25.208C5.1063 25.8896 4.84877 26.2304 4.85719 26.691C4.8637 27.0469 5.08717 27.4959 5.36718 27.7156C5.72961 28 6.23185 28 7.23633 28H24.7637C25.7682 28 26.2704 28 26.6329 27.7156C26.9129 27.4959 27.1363 27.0469 27.1429 26.691C27.1513 26.2304 26.8938 25.8896 26.3787 25.208C23.9856 22.0408 20.2268 20 16 20Z"
        stroke="#FEFEFE"
        strokeWidth="2"
        strokeLinecap="round"
