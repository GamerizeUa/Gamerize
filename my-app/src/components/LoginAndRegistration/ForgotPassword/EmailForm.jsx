...
export const EmailForm = () => {
    ...
    const handleSubmit = () => {
        if (email && emailRegex.test(email)) {
            axios
                .post('https://gamerize.ltd.ua/api/Login/forgot-password', {
                    email: email,
                })
    ...
    return (
        <div
            className={stylesCommon.popUp_background}
            onClick={closePopupByClicking}
        >
            <div className={styles.emailPopup}>
                <div
                    className={`${stylesCommon.popUp_header} ${styles.header}`}
                >
                    <div
                        className={stylesCommon.popUp_cross}
                        onClick={closePopUp}
                    ></div>
                </div>
                    ...
                    {isConfirmMessage ? (
                        <div className={stylesCommon.confirmEmail}>
                            <Lottie
                                ...
                                className={stylesCommon.confirmEmail_gif}
                            />
                            <div className={stylesCommon.confirmEmail_info}>
                                <p className={stylesCommon.confirmEmail_title}>
                                    Перейдіть за посиланням у листі
                                </p>
                                <p
                                    className={
                                        stylesCommon.confirmEmail_subtitle
                                    }
                                >
                                    Перейдіть на email, щоб завершити скидання
                                    паролю.
                                </p>
                            </div>
                        </div>
                        ...
                        <>
                            ...
                            <div className={stylesCommon.popUp_formGroup}>
                                ...
                                <div
                                    className={
                                        stylesCommon.popUp_inputContainer
                                    }
                                >
                                ...
                                {error && (
                                    <p className={stylesCommon.input_error}>
                                        {error}
                                    </p>
                                )}
                            </div>
