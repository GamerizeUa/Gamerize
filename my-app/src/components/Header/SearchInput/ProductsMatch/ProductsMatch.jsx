            ...
            <div className={styles.matches}>
                <div className={styles.matches_container}>
                    <div className={styles.matches_list}>
                        ...
                        {products.length === 0 && (
                            <p className={styles.matches_text}>
                                Товарів за запитом <span>'{searchText}'</span>{' '}
                                не знайдено
                            </p>
                        )}
                    </div>
                    {products.length > 0 && (
                        <div
                            className={styles.matches_all}
                            onClick={showAllMatchesInCatalog}
                        >
                            <p>Переглянути всі</p>
                        </div>
                    )}
