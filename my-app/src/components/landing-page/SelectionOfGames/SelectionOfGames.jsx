            ...
            <div className={styles.gamesSelection_outerContainer + " container"}>
                ...
                <div className={styles.gamesSelection_container}>
                    <Link className={styles.gamesSelection_choice} to="/" >
                        <img src={imageCompanyGame} className={styles.gamesSelection_image} alt="People" />
                        <p className={styles.gamesSelection_category}>ТОП 10 ігор для компанії</p>
                    </Link>
                    <Link className={styles.gamesSelection_choice} to="/">
                        <img src={imageCoupleGame} className={styles.gamesSelection_image} alt="People" />
                        <p className={styles.gamesSelection_category}>ТОП 10 ігор для пар</p>
                    </Link>
                    <Link className={styles.gamesSelection_choice} to="/">
                        <img src={imageKidsGame} className={styles.gamesSelection_image} alt="People" />
                        <p className={styles.gamesSelection_category}>ТОП 10 ігор для дітей</p>
                    </Link>
                    <Link className={styles.gamesSelection_choice} to="/">
                        <img src={imageTwoGame} className={styles.gamesSelection_image} alt="People" />
                        <p className={styles.gamesSelection_category}>ТОП 10 ігор для двох</p>
                    </Link>
                </div>
            </div>
        </section>
