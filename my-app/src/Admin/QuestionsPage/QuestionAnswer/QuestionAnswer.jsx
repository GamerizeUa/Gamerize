...
export const QuestionAnswer = () => {
    ...
    const getQuestionDetails = () => {
        axios
            .get(`https://gamerize.ltd.ua/api/Question/GetById/${id}`)
            .then((res) => {
    ...
    const sendAnswer = () => {
        axios
            .post(
                `https://gamerize.ltd.ua/api/Question/Questions/${id}/Answer`,
                {
            ...
            <div className={styles.answer}>
                <div className={styles.answer_container}>
                    <div className={styles.answer_header}>
                        <p className={styles.answer_clientName}>
                            {question.userName}
                        </p>
                        <span>Вхідні</span>
                    </div>
                        ...
                        <div className={styles.answer_body}>
                            ...
                            <div className={styles.answer_content}>
                                <div className={styles.answer_info}>
                                    ...
                                    <p className={styles.answer_time}>
                                        {formatDate(dateOfQuestion)}
                                    </p>
                                </div>
