            ...
            <div className={styles.banner_outerContainer + ' container'}>
                <div className={styles.banner_container}>
                    <div className={styles.banner_leftPart}>
                        ...
                        <img
                            src={presentBox}
                            className={styles.banner_presentBox}
                            alt="Present box"
                        />
                        <div className={styles.banner_starContainerThirty}>
                            <img
                                src={star}
                                className={styles.banner_starThirty}
                                alt="Star"
                            />
                            <span className={styles.banner_starPromo}>
                                -30%
                            </span>
                        </div>
                    </div>
                    <div className={styles.banner_rightPart}>
                        <div className={styles.banner_starContainerFifty}>
                            <img
                                src={star}
                                className={styles.banner_starFifty}
                                alt="Star"
                            />
                            <span className={styles.banner_starPromo}>
                                -50%
                        ...
                        <div className={styles.banner_starContainerTwentyFive}>
                            <img
                                src={star}
                                className={styles.banner_starTwentyFive}
                                alt="Star"
                            />
                            <span className={styles.banner_starPromo}>
                                -25%
                        ...
                        <img
                            src={product}
                            className={styles.banner_product}
                            alt="Present box"
                        />
                    </div>
                </div>
